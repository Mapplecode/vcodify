...
class Home(View):
    ...
    def post(self,request):
        if request.method == "POST":
            ...
            send_mail("Vcodify Technologies",'''Thanks for submitting.\nWe will reach you as soon as possible.''', EMAIL_HOST_USER, [email], fail_silently = False)
...
class Apply(View):
    ...
    def post(self,request):
        if request.method == "POST":
            ...
            send_mail("Vcodify Technologies",'''Thanks for submitting the form.\nWe appreciate your decision to connect with us.''', EMAIL_HOST_USER, [email], fail_silently = False)
