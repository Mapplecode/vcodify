...
class Home(View):
    ...
    def post(self,request):
        if request.method == "POST":
            ...
            send_mail("Vcodify Technologies",'''Thank's for submitting.\nWe will reached you as soon as possible.''', EMAIL_HOST_USER, [email], fail_silently = False)
...
class Apply(View):
    ...
    def post(self,request):
        if request.method == "POST":
            ...
            send_mail("Vcodify Technologies",'''Thank's for submitting the form.\nWe appreciate you're decision to connect with us.''', EMAIL_HOST_USER, [email], fail_silently = False)
